...
def main(config,
    ...
    for dom in range(n_domains):
        ...
        # find goal
        goal_path = 'data\\scenarios_grid\\Scenario_goal' + str(11) + '.png'
        ...
        grid_path = 'data\\scenarios_grid\\Scenario_' + str(11) + '_grid.png'
        ...
        mat_path = 'data\\scenario_states\\Gen' + str(11) + '.mat'
        ...
        for i in range(n_traj):
            if len(X[i]) > 1:
                ...
                pred_traj[0, :] = [X[i][0], Y[i][0]]

                gamme = math.radian(45)
